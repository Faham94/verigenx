...
class axi_ref_model extends uvm_object;
    ...
    virtual function void predict(axi_seq_item item, ref axi_seq_item expected);
        expected = axi_seq_item::type_id::create("expected");
...
class axi_scoreboard extends uvm_scoreboard;
    ...
    virtual function void build_phase(uvm_phase phase);
        ...
        if (!uvm_config_db#(axi_ref_model)::get(this, "", "ref_model", ref_model)) begin
            `uvm_info("SB", "No reference model injected. Creating default reference model.", UVM_MEDIUM)
            ref_model = axi_ref_model::type_id::create("ref_model");
        end
    endfunction
